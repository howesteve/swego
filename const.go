...
const (
	...
	SidmTrueSheoran             Ayanamsa = 39
	SidmGalcentCochrane         Ayanamsa = 40
	SidmGalequFiorenza          Ayanamsa = 41
	SidmValensMoon              Ayanamsa = 42
	SidmiLahiri1940             Ayanamsa = 43
	SidmiLahiriVP285            Ayanamsa = 44
	SidmiKrishnamurtiVP291      Ayanamsa = 45
	SidmiKrishnamurtiLahiriICRC Ayanamsa = 46
